...
OBJECTS=DeepClassRBM.o MultiLayerRBM.o ClassRBM.o MLP.o RBM.o Logistic.o MLPLayer.o TrainModel.o MultiLayerTrainComponent.o TrainComponent.o Dataset.o Utility.o
...
MODELS=LogisticModel MLPModel RBMModel DBN ClassRBMModel DeepClassRBMModel
